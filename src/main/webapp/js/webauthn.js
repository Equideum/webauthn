...
function fetchCredentials() {
  _fetch('/wan/RegisteredKeys').then(response => {
    let credentials = '';
...
function addCredential() {
  ...
  return _fetch('/wan/BeginMakeCredential', {
    advanced: true,
    ...
    return _fetch('/wan/FinishMakeCredential', {
...
function getAssertion() {
  ...
  let _parameters;
  _fetch('/wan/BeginGetAssertion').then(parameters => {
